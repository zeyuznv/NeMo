...
from nemo.collections.asr.modules.model_dss import UNet
...
__all__ = ['MultiChannelConvASREncoder', 'ConvASRDecoder', 'ConvASREncoder', 'ConvASRDecoderClassification']

class MultiChannelConvASREncoder(NeuralModule):
    """
    ...
    def __init__(
        ...
        quantize: bool = False,
        unet_basefilters: int = 64,
        unet_kernel_type: str = 'square',
    ):
        super().__init__()
